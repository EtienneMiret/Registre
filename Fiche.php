...
<?php } ?>
<?php $acteur = mysql_fetch_assoc($acteurs); ?>
<?php if ($acteur) { ?>
	  <p>Avec
<?php do { ?>
...
<?php if (isset($general['dernier_editeur'])) { ?>
	    <li>Dernière modification par <?php echo htmlspecialchars($general['dernier_editeur']) ?>
<?php } ?>
<?php if (isset($general['derniere_edition'])) { ?>
 le <?php echo htmlspecialchars($general['derniere_edition']) ?></li>
<?php } ?>
