...
<?php
/* On n’affiche la barre de navigation que si l’utilisateur est authentifié. */
if ($reg_user) { ?>
			<nav id="main-nav">				<ul>
					<li class="<?php if ($reg_page == 2) echo 'active'; ?>"><a href="<?php echo htmlspecialchars($reg_racine); ?>ChangerMdp">Mon profil</a></li>
					<li class="<?php if ($reg_page == 3) echo 'active'; ?>"><a href="<?php echo htmlspecialchars($reg_racine); ?>">Toutes les références</a></li>
